...
from mcp_server.server import UnknownToolError, handle_analyze_competitor


async def test_analyze_competitor_tiktok_only() -> None:
    mock_posts: list[dict[str, object]] = [
        {"url": "https://tiktok.com/v/1", "desc": "Promo", "likes": 1000}
    ]
...
async def test_analyze_competitor_all_platforms() -> None:
    tiktok_posts: list[dict[str, object]] = [{"url": "t1", "desc": "d", "likes": 10}]
    ig_posts: list[dict[str, object]] = [{"url": "i1", "caption": "c", "likes": 20}]
    fb_posts: list[dict[str, object]] = [{"text": "f1", "likes": 30, "time": "2026-05-01"}]
...
async def test_analyze_competitor_skips_unselected_platforms() -> None:
    fb_posts: list[dict[str, object]] = [{"text": "fb post", "likes": 5, "time": "2026-05-01"}]
