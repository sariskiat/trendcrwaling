...
- **Harness Scheduling Convention:** When an implementor returns FAILED, temporarily quarantine that issue for the rest of the run so supervisor can try other AFK issues instead of reselecting the same issue repeatedly.
